                                        ...
                                        <TabsList className="h-10 bg-gray-100 rounded-xl">
                                            {sectors.slice(0, 4).map((sector) => (
                                                <TabsTrigger
                                                    key={sector}
                                                    value={sector}
                                                    className="rounded-md px-4 py-2 data-[state=active]:bg-blue-600 data-[state=active]:text-white text-gray-700 hover:text-blue-600"
                                                >
                                                    {sector}
                                                </TabsTrigger>
                                            ))}
                                            ...
                                            <td className="px-6 py-4 hidden lg:table-cell">
                                                <div className="w-32 h-10">
                                                    <AreaChart
                                                        ...
                                                        index="date"
                                                        categories={["Price"]}
                                                        colors={[stock.changePercent >= 0 ? "green" : "red"]}
                                                        showLegend={false}
                                                        showXAxis={false}
                                                        showYAxis={false}
                                                        showGridLines={false}
                                ...
                                {stocks
                                    ...
                                    .map((stock, i) => (
                                        ...
                                        >
                                            ...
                                            <div className={cn(
                                                "flex items-center gap-3 px-2 py-1 rounded-lg text-xs font-medium",
                                                stock.changePercent >= 0
                                                    ? "text-green-700 bg-green-100"
                                                    : "text-red-700 bg-red-100"
                                            )}>
